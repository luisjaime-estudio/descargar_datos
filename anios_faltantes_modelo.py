...
Busca archivos NetCDF recursivamente, extrae `source_id`, ensamble y anio de
inicializacion (desde `member_id`, por ejemplo `s1960-r1i1p1f1`) y calcula
los anios faltantes por combinacion modelo+ensamble dentro del rango esperado.
"""
