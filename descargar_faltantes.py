...
Entrada esperada: CSV generado por `anios_faltantes_modelo.py` con columnas:
- modelo
- ensamble
- lista_anios_faltantes

Para cada combinacion modelo+ensamble+anio faltante intenta descargar desde ESGF
y reorganiza los `.nc` a la estructura:
    datos/<Modelo>/<ensamble>/sYYYY/archivo.nc
"""
